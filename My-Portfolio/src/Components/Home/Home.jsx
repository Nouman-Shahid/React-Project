...
const Home = () => {
  ...
  // Scroll to the 'Home' section when the page is first loaded
  useEffect(() => {
  ...
  return (
    <>
      ...
      <section ref={homeRef} className={styles.home}>
        ...
        <div className={styles.icons} data-aos="fade-right" data-aos-duration="1500">
         ...
         <a href="https://github.com/Nouman-Shahid"><img src="images/github.png" alt="" /></a>

        </div>
        
        <div className={styles.text} data-aos="fade-right" data-aos-duration="1500">

          <h2>Hello, I am <br /> <br /> <span>Numan Shahid</span></h2>

          <p>"Front-End Developer with <span>Full-Stack</span> Ambitions." 👨‍💻</p>

          <div className={styles.btns} >
            <button  onClick={() => scrollToSection(aboutRef, 'About')}
            className={activeLink === 'About' ? style.activeLink : ''}>About Me</button>
            <button onClick={() => scrollToSection(contactRef, 'Contact')}
            className={activeLink === 'Contact' ? style.activeLink : ''}>Hire Me</button>
      ...
      <img src="images/myimage.jpg" alt="" data-aos="fade-left" data-aos-duration="1500" />
